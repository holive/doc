...
type Repository interface {
	...
	Find(ctx context.Context, projeto string, versao string) (*DocApi, error)
	FindBySquad(ctx context.Context, squad string, limit string, offset string) (*SearchResult, error)
	SearchProject(ctx context.Context, project string, limit string, offset string) (*SearchResult, error)
